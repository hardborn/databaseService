...
@Table(name = "alarm_data_env_item")
public class AlarmDataEnvItem {
    @Id
    @Column(name = "alarm_item_uid")
    private String alarmItemUid;
    ...
    /**
     * @return alarm_item_uid
     */
    public String getAlarmItemUid() {
        return alarmItemUid;
    }
     ...
     * @param alarmItemUid
     */
    public void setAlarmItemUid(String alarmItemUid) {
        this.alarmItemUid = alarmItemUid;
    }
